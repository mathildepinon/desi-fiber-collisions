...
def get_power_marg_likelihood(data, theory, wmatrix, cov, wmatrix_rpcut=None, shotnoise=None, ells=[0, 2, 4], idces=[-1], solve=True, kobsmax=0.2):
    ...
    if wmatrix_rpcut is None:
        ...
        klim = {0: [0.02, kobsmax-0.005, 0.005], 2: [0.02, kobsmax-0.005, 0.005], 4: [0.02, kobsmax-0.005, 0.005]}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--marg_idx', nargs='*', default=None)
    ...
    likelihood = get_power_marg_likelihood(data, theory_name, wmatrix, cov, wmatrix_rpcut=wmatrix_rpcut, shotnoise=shotnoise, ells=[0, 2, 4], idces=[-1], solve=True, kobsmax=kobsmax)
    #likelihood()
