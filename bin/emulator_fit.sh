...
#srun -n 8 --cpu_bind=cores python /global/u2/m/mpinon/fiber_collisions/desi_fiber_collisions/bin/emulator_fit.py --todo 'emulator' --source 'desi' --catalog "second" --version 'v4_1' --observable 'power' --tracer 'ELG_LOP' --zmin 1.1 --zmax 1.6 --z 1.325
...
#srun -n 33 --cpu_bind=cores python /global/u2/m/mpinon/fiber_collisions/desi_fiber_collisions/bin/emulator_fit.py --todo 'emulator' --source 'desi' --catalog "cubic" --version 'v1.1' --tracer 'ELG' --observable 'power' --z 1.325 --zmin 1.1 --zmax 1.6
