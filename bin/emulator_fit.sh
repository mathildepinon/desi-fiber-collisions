...
srun -n 33 --cpu_bind=cores python /global/u2/m/mpinon/fiber_collisions/desi_fiber_collisions/bin/emulator_fit.py --todo 'emulator' --source 'local' --catalog "cubic" --tracer 'ELG' --power True --redshift 1.325
srun -n 33 --cpu_bind=cores python /global/u2/m/mpinon/fiber_collisions/desi_fiber_collisions/bin/emulator_fit.py --todo 'profiling' --source 'local' --catalog "cubic" --tracer 'ELG' --power True --redshift 1.325